...
(function() {
    var MirrorShield = function(scene, x, y) {
        deathrace.gameobjects.powerups.PowerUp.call(this, scene, x, y, "powerups.MS");
        this.name = "mirror-shield";
    };

    MirrorShield.prototype = Object.create(deathrace.gameobjects.powerups.PowerUp.prototype);
    MirrorShield.prototype.constructor = MirrorShield;
