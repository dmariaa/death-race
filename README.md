...
Para la fase de testeo y documentación de errores, primero se realizo una primer análisis en la fase previa a la 4, encontrando unos pocos errores. Tras completar la fase 4, se realizo un nuevo análisis, donde se encontraron diferentes tipos de errores que estropeaban numerosas mecánicas y experiencias de juego. Para realizar esto pues, los integrantes que se encargaron de la fase de testeo subieron los errores encontrados al apartado Issues de Github, permitiendo que los encargados de solucionar dichos problemas los cerrasen.
...
Web libre de derechos para música de fondo: 
